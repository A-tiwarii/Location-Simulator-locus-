...
const { degreeToRadian } = require("./RadianFromDegreeConverter");
const calculateBearing = require("./BearingCalculator");
const calculateGLatLong = require("./NextCoordinateCalculator");
